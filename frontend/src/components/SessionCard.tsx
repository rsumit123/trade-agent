      ...
      <div className="bg-bg-card border border-border rounded-xl p-5 hover:border-border-accent hover:bg-bg-card-hover transition-all cursor-pointer group">
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <span className={cn("inline-block mt-1 text-[10px] uppercase tracking-wider font-semibold px-2 py-0.5 rounded border", marketColors[session.market] || "bg-bg-secondary text-text-muted border-border")}>
              {session.market}
            </span>
          </div>
